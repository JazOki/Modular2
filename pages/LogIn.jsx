        ...
        <div id="contenedorPrincipal" className="h-screen w-screen flex flex-col">
            <div id="contenedorIzquierdo" className="w-2/3 bg-gray-800">
                ...
                <form onSubmit={onSubmitLoginForm}>
                    ...
                    <div className="pl-24 pt-2"><input type="text" className="w-48 rounded" value={usuario} onChange={(eventInput) => setUsuario(eventInput.target.value)}></input> 
                    ...
                    <div className="pl-24 pt-2"><input type="password" className="w-80 rounded" value={contrasenia} onChange={(eventInput) => setContrasenia(eventInput.target.value)}></input> </div>
