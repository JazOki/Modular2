  ...
  return (
    <div className="h-screen w-screen flex">
      ...
      <div className="w-full flex flex-col bg-gray-800">
        ...
        <div className="font-serif  text-xl text-left pl-10 text-white ">Titulo<input type="text"></input></div>
        <div id="moduloBox" className="font-serif text-xl text-left  text-white pl-24 pt-2">Modulo
        ...
        <div id="moduloBox" className="font-serif text-xl text-left text-white pl-24 pt-2">Asesor
          <select name="select" className="font-serif  rounded bg-white text-black w-80">
